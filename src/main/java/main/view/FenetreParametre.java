...
public class FenetreParametre extends JFrame {
    ...
    public class PanneauParam extends JPanel {
        ...
        public PanneauParam( FenetreParametre fen ) throws NumberFormatException, IOException {
            ...
            JPanel midLeftPanel = new JPanel( new GridLayout( 9, 1 ) );
        ...
        public void applyPreferences() {
            ...
            maxPhraseByPage.setText( param.maxPhraseByPage + "" );
        ...
        /**
         * Enregistre les préférences en fonction de la sélection de
         * l'utilisateur.
         */
    ...
    public void lancerExercice() {
        ...
        if ( param.fixedField ) {
            ...
            fenetre.pan.panelFenetreFixe
                    .setPreferredSize( new Dimension( fenetre.getWidth(), param.police.getSize() ) );
