...
public class Panneau extends JDesktopPane {
    ...
    public Panneau( Fenetre fenetre, FenetreParametre fenetreParam, Parametres param ) throws IOException {
        ...
        if ( !textHandler.oneHoleEqualOneWord() ) {
            ...
            // fenetreParam.pan.fixedField.setText("Un seul mode disponible pour
            // ce texte");
        ...
        while ( lastPhrase < textHandler.getPhrasesCount() ) {
            ...
            int off = textHandler.getAbsoluteOffset( lastPhrase, editorPane.viewToModel( new Point(
                    ...
                    (int) ( editorPane.getHeight() - h
                            - ( param.fixedField ? panelFenetreFixe.getHeight() : 0 ) ) ) ) );
    ...
    public boolean pageFinis() {
        // la page actuelle contient t-elle le segment suivant ? si non elle est
        // finis
    ...
    /**
     * Affiche une fenetre correspondant au mot d�limit� par start et end,
     * d'indice numeroCourant, et met le masque correspondant dans la liste des
     * masques
     */
    ...
    /**
     * Renvoie le nombre d'occurrences de la sous-chaine de caract�res sp�cifi�e
     * dans la chaine de caract�res sp�cifi�e
     * 
     * @param text
     *            chaine de caract�res initiale
     * @param string
     *            sous-chaine de caract�res dont le nombre d'occurrences doit
     *            etre compt�
     * @return le nombre d'occurrences du pattern sp�cifi� dans la chaine de
     *         caract�res sp�cifi�e
     */
    ...
    /**
     * Renvoie le nombre d'occurrences du pattern sp�cifi� dans la chaine de
     * caract�res sp�cifi�e
     * 
     * @param text
     *            chaine de caract�res initiale
     * @param regex
     *            expression r�guli�re dont le nombre d'occurrences doit etre
     *            compt�
     * @return le nombre d'occurrences du pattern sp�cifi� dans la chaine de
     *         caract�res sp�cifi�e
     */
