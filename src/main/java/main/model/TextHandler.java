...
public class TextHandler {
    ...
    /**
     * Retourne la position du début du segment d'indice <i>phrase</i>, relative
     ...
     * position d'un caractére cliqué é partir d'un segment indiqué.
     */
    ...
    /**
     * Ceci est l'opération inverse, elle permet d'obtenir la position par
     * rapport au premier segment affiché avec la position du caractére dans
     * tout le texte.
     */
    ...
    /**
     * Retourne <code>true</code> si le segment indiqué contient au moins un
     * trou.
     */
