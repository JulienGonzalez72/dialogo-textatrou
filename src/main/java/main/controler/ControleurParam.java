...
public class ControleurParam implements ActionListener, ChangeListener {
     ...
     *            la police
     * @param :
     *            l'index du font dans la liste des polices de la
     *            FenetreParametre
     * @param :
     *            le style
     * @param :
    ...
    /**
     * Retourne vrai si : - Aucune couleur n'est s�lectionn�e en double - Les
     * champs saisies sont coh�rents
     */
    ...
    private boolean couleursUniques() {
        ...
        if ( occurence( param.bgColor, couleursUtilisées ) != 1
                || occurence( param.rightColor, couleursUtilisées ) != 1 ) {
            r = false;
        }
        return r;
    }
